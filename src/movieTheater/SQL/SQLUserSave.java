...
public class SQLUserSave extends SQL {
	...
	public int createUser(String fNavn, String eNavn, int tlf, String pWord, int rolle, String vej, int nr, int postNr, String brugernavn) throws SQLException 
	{
		openConnection();
