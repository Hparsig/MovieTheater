...
public class DeleteEmployee extends JFrame {
	 ...
	 * Create the frame.
	 */
	public DeleteEmployee(EmployeeController employeeCon) {
		...
		employeesList.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				String name = employees.get(choosen).getfName();
			    ...
			    try
			    {
			    	employeeController.deleteEmployee(result, employees.get(choosen));
		
			    }
			    catch(SQLException e)
			    {
			    	JOptionPane.showMessageDialog(new JFrame(), "Fejl i forbindelse til database");  
			    }
			    catch(Exception e)
			    {
			    	JOptionPane.showMessageDialog(new JFrame(), "Fejl i sletning af medarbejder");  
			    }
			    latch.countDown();
			}
		});
